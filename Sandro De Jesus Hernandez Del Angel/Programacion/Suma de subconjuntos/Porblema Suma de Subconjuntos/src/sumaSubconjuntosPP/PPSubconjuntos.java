 ...
 * @author saipr
 */
public class PPSubconjuntos
{

    static String s = ""; //Guarda los subconjuntos que sumen la suma deseada
    static String ns = "";
     ...
     */
    public static void iniSumSubconjuntos(int[] conjunto, int sumD)
    {
